        ...
        <div class="card-body">
            <form action="{{ route('travel-package.update', $item->id) }}" method="post">
                ...
                <div class="form-group">
                    ...
                    <textarea name="about" rows="3" class="d-block w-100 form-control">{{ $item->about }}</textarea>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" name="departure" placeholder="Departure Date" value="{{ $item->departure }}">
                </div>
                <div class="form-group">
