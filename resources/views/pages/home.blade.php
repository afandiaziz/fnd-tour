...
<div class="jumbotron text-center">
   <div class="container">
      ...
      <a class="btn btn-primary px-4 mt-4 waves-effect" href="javascript:void(0)" role="button">Get Started</a>
   </div>
</div>
<main>
   <div class="container">
         ...
         <div class="container">
            <div class="row justify-content-center">
               <div class="col-lg-3 col-md-4 col-sm-6 col-6 text-center">
                  <div class="card-travel d-flex flex-column" style="background-image: url('assets/img/popular-1.jpg');">
      ...
      <div class="container">
         <div class="row justify-content-center">
            ...
            <div class="col-12 text-center mt-5">
               ...
               <a href="javascript:void(0)" class="btn btn-primary waves-effect px-4 font-weight-bold mx-2">Get Started</a>
            </div>
         </div>
      </div>
   </section>
